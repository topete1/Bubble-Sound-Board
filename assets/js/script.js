// Vanilla JS screen size
// var screenW = window.screen.availWidth;
// var screenH = window.screen.availHeight;
// console.log(screenW);
// console.log(screenH);
// for (var x = 0; x <= screenW; x += 20) {
//     for (var y = 0; y < screenH; y += 20) {
//         var dots = new Path.Circle(new Point(x, y), 2).fillColor = "green";
//     }
// }
...
function onKeyDown(event) {
    if (keyData[event.key]) {
        ...
        var point = maxPoint * randomPoint; // final coordinates in screen
